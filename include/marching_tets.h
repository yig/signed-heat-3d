...
namespace ygl {
  ...
  /// @param[in] isovalue_eps  scalar -- An perturbation to add to isovalue when computing topology (but not geometry)
  ...
  IGL_INLINE void marching_tets(
      ...
      const typename DerivedS::Scalar isovalue_eps,
  ...
  IGL_INLINE void marching_tets(
      ...
      Eigen::PlainObjectBase<DerivedJ>& J,
      Eigen::SparseMatrix<BCType>& BC) {
    return ygl::marching_tets(TV, TT, S, 0.0, SV, SF, J, BC);
  }
  /// \overload
  template <typename DerivedTV,
            typename DerivedTT,
  ...
  IGL_INLINE void marching_tets(
    ...
    return ygl::marching_tets(TV, TT, S, isovalue, SV, SF, J, _BC);
  }
  /// \overload
  template <typename DerivedTV,
            typename DerivedTT,
  ...
  IGL_INLINE void marching_tets(
      ...
      Eigen::SparseMatrix<BCType>& BC) {
    Eigen::VectorXi _J;
    return ygl::marching_tets(TV, TT, S, isovalue, SV, SF, _J, BC);
  }
  /// \overload
  template <typename DerivedTV,
            typename DerivedTT,
  ...
  IGL_INLINE void marching_tets(
    ...
    Eigen::VectorXi _J;
    Eigen::SparseMatrix<typename DerivedSV::Scalar> _BC;
    return ygl::marching_tets(TV, TT, S, isovalue, SV, SF, _J, _BC);
  }
